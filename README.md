...
* **AI-powered commands**: Natural-language coding and file management powered by Claude, Codex, Gemini, Gajae-Code, and OpenCode. Press `.` and describe what you want done.
...
* Multi-provider support (Claude, Codex, Gemini, Gajae-Code, OpenCode) with real-time streaming
