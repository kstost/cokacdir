...
* **AI-powered commands**: Natural-language coding and file management powered by Claude, Codex, Gemini, Kiro, and OpenCode. Press `.` and describe what you want done.
...
* Multi-provider support (Claude, Codex, Gemini, Kiro, OpenCode) with real-time streaming
